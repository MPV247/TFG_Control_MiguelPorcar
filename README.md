...
│   ├── ⚙️ controladores_Kx_cartpole/     // Comparativas de transitorios con matrices Q y R
│   ├── 📈 control_Kx_integrador/        // Ensayos del controlador con acción integral
...
│   └── ⚙️ simulink/                     // Modelos de bloques .slx y pasarela ROS
│
...
│       ├── 🎛️ rviz/                     // Configuraciones gráficas de RViz
